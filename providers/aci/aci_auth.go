...
func (t *ACIAuth) estimateExpireTime() int64 {
	return time.Now().Unix() + t.offset
}

func (client *ACIClient) InjectAuthenticationHeader(req *http.Request, path string) (*http.Request, error) {
