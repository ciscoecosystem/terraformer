...
// ACIClient is the main entry point
...
var clientImpl *ACIClient

type Option func(*ACIClient)
...
func initClient(clientUrl, username string, options ...Option) *ACIClient {
	...
	client.ACIServiceManager = NewServiceManager(client.MOURL, client)
	return client
}
...
func (c *ACIClient) useInsecureHTTPClient(insecure bool) *http.Transport {
...
func (c *ACIClient) MakeRestRequestRaw(method string, rpath string, payload []byte, authenticated bool) (*http.Request, error) {
...
func (c *ACIClient) MakeRestRequest(method string, rpath string, body *container.Container, authenticated bool) (*http.Request, error) {
...
func (c *ACIClient) Authenticate() error {
	method := "POST"
...
func (c *ACIClient) Do(req *http.Request) (*container.Container, *http.Response, error) {
